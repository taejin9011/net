...
public class SwingChatClient extends JFrame implements ActionListener, Runnable{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == btnConnect){
			...
			/*
			 * 이 클래스인 SwingChatClient 이 Runnable을 
	...
	private void send() {
		...
		txtInput.requestFocus(); // 입력창에 글자가 없으니까 커서 깜빡거리는 기능
		pw.println(text);  // pw는 PrintWriter의 객체로 화면에 글자를 뿌려라 
		pw.flush();  // flush() 물내림이라는 뜻으로 pw 에게 가지고 있는 데이터를 전부
					 // 삭제하라는 뜻
	}
}
